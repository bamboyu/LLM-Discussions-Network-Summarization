...
def run_generator():
    """
    Hàm chính để đọc dữ liệu GCN, chạy vòng lặp tóm tắt và lưu kết quả.
    """
    # [SỬA LẠI CHO GCN]: Đọc file kết quả của GCN Inference
    input_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../data/processed/extracted_contexts_for_llm_gcn.json'))
    
    # [SỬA LẠI CHO GCN]: Lưu file tóm tắt của GCN
